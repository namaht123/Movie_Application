...
public class DetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        idFila = getIntent().getIntExtra("id",0);
        initView();
        sendRequest();
    }
    ...
    private void sendRequest() {
        ...
        mStringRequest = new StringRequest(Request.Method.GET, "https://moviesapi.ir/api/v1/movies/" + idFila, new Response.Listener<String>() {
            @Override
    ...
    private void initView() {
        ...
        movieActorInfo = findViewById(R.id.movieActor);
        backImg = findViewById(R.id.backImg);
        recyclerViewCategory = findViewById(R.id.genreView);
        recyclerViewActor = findViewById(R.id.imagetRecyview);
